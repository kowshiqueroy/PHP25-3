...
if ($result->num_rows > 0): ?>
    ...
    <table style="width: 100%; border-collapse: collapse;">
        <thead>
            <tr style="background-color: #f2f2f2; text-align: center; font-size: 10px;">
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">SN</th>
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">Product</th>
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">Shop Qty</th>
                ...
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">Date Problem</th>
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">Broken</th>
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">VHsealing</th>
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">Insect</th>
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">Soft</th>
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">Bodyleakage</th>
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">Others</th>
                <th style="writing-mode: vertical-rl; transform: rotate(180deg); height: 50px; vertical-align: center; padding: 5px; border: 1px solid black;">Good</th>
