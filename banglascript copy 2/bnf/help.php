...
- Parse according to the banglascript grammar (variable declarations with box, assignments, if/else, loop with fixed count or while-style conditions, input(...), output(...))
