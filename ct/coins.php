...
<section>
    ...
    <section>
      ...
      <div class="form-group">
        <label>Username / Phone Number / Account</label>
        <input type="text" placeholder="To"  />
      </div>
      <div class="form-group">
        <label>Amount</label>
        <input type="number" placeholder="Amount" value="100" />
      </div>
      <div class="form-group">
        <label>Reason</label>
        <div class="radio-group">
          <label><input type="radio" name="reason" value='1' /> Withdraw</label>
          <label><input type="radio" name="reason" value='2' /> Recharge</label>
          <label><input type="radio" name="reason" value='3' checked /> Send</label>
        </div>
      </div>
