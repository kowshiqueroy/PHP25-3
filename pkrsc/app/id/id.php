...
//data from settings table can be used here later
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $school_logo_path = "../".$row['school_logo'];
...
<button class="print-button1" onclick="window.location.href = '../../index.php'">Visit Website</button>
