...
<head>
    ...
    <title>পারভেজ খান রেসিডেন্সিয়াল স্কুল এন্ড কলেজ | হাড়োরা, নীলফামারী</title>
...
<body>
    ...
    <header class="top-bar">
        <div class="container">
            <div class="top-bar-info">
                ...
                <span><i class="fa-solid fa-envelope"></i> ইমেইল: info@pkrsac.edu.bd</span>
            </div>
    ...
    <main>
        ...
        <section id="introduction" class="container">
            ...
            <div class="card">
                <p>পারভেজ খান রেসিডেন্সিয়াল স্কুল এন্ড কলেজ, ২০১৮ সালে প্রতিষ্ঠিত, নীলফামারীর হাড়োরা এলাকায় অবস্থিত একটি স্বনামধন্য শিক্ষা প্রতিষ্ঠান। আমরা শিক্ষার্থীদের মেধা ও মননের বিকাশে অঙ্গীকারবদ্ধ। আধুনিক শিক্ষা উপকরণ, অভিজ্ঞ শিক্ষক মণ্ডলী এবং একটি শিক্ষাবান্ধব পরিবেশ নিশ্চিত করার মাধ্যমে আমরা প্রতিটি শিক্ষার্থীকে ভবিষ্যতের জন্য যোগ্য নাগরিক হিসেবে গড়ে তুলতে সচেষ্ট। আমাদের লক্ষ্য শুধু একাডেমিক সাফল্যই নয়, বরং মানবিক মূল্যবোধ সম্পন্ন মানুষ তৈরি করা।</p>
            </div>
        </section>
        ...
        <section id="admission" class="container">
            ...
            <div class="grid-2">
                ...
                <div class="admission-info card">
                    ...
                    <h4>যোগাযোগ</h4>
                    <p>
                        <strong>ঠিকানা:</strong> হাড়োরা, নীলফামারী সদর, নীলফামারী।<br>
    ...
    <footer>
        <div class="container footer-grid">
            <div class="footer-widget">
                ...
                <p><i class="fa-solid fa-location-dot"></i> ঠিকানা: হাড়োরা, নীলফামারী সদর, নীলফামারী।</p>
                <p><i class="fa-solid fa-phone"></i> ফোন: ০১৫২১২১২১২১১</p>
                <p><i class="fa-solid fa-envelope"></i> ইমেইল: info@pkrsac.edu.bd</p>
            </div>
        ...
        <div class="container copyright">
            <p>&copy; ২০২৫ পারভেজ খান রেসিডেন্সিয়াল স্কুল এন্ড কলেজ। সর্বস্বত্ব সংরক্ষিত।</p>
        </div>
    </footer>
