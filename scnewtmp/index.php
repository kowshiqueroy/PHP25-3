...
$settings_stmt = $pdo->query("SELECT setting_key, setting_value FROM site_settings WHERE setting_key IN ('email', 'principal_message', 'principal_image')");
$settings = $settings_stmt->fetchAll(PDO::FETCH_KEY_PAIR);

$email = $settings['email'] ?? 'Principal Name';
            ...
            <div class="card">
                <div style="display: flex; gap: 20px; align-items: center; flex-wrap: wrap; justify-content: center;">
                    ...
                    <div>
                        ...
                        <p style="color: var(--primary); font-weight: bold;  text-align: center;"><?php echo htmlspecialchars($email); ?></p>
                    </div>
                </div>
            </div>
