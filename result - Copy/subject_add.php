        ...
        <div class="col-lg-10">
            <form method="POST" id="subjectForm">
                ...
                <div id="partsContainer">
                    <div class="card border-primary mb-3 part-card">
                        <div class="card-header bg-light d-flex justify-content-between align-items-center">
                            <input type="text" name="parts[0][name]" class="form-control form-control-sm w-50" value="-" required>
                        ...
                        <div class="card-body">
                            <table class="table table-sm table-borderless align-middle">
                                ...
                                <tbody class="comp-container">
                                    <tr>
                                        <td><input type="text" name="parts[0][comps][0][name]" class="form-control form-control-sm" value="CQ" required></td>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <button type="button" class="btn btn-outline-dark" id="addPart">+ Add Another Part (2)</button>
                    <div>
...
document.getElementById('addPart').addEventListener('click', function() {
    ...
    partDiv.innerHTML = `
        <div class="card-header bg-light d-flex justify-content-between align-items-center">
            <input type="text" name="parts[${partCount}][name]" class="form-control form-control-sm w-50" placeholder="Part Name (2)" required>
            <div class="d-flex align-items-center gap-2">
                <label class="small fw-bold">Part Pass:</label>
