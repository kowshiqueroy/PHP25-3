...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE settings SET 
            ...
            emis=?, school_code=?, website=?, established=?, school_logo=? 
            WHERE id=1";
    $stmt = $pdo->prepare($sql);
    
    if ($stmt->execute([$name, $address, $phone, $email, $emis, $school_code, $website, $session, $logoPath])) {
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="emis" class="form-control" value="<?php echo htmlspecialchars($settings['emis'] ?? ''); ?>">
                        </div>
                         <div class="col-md-6 mb-3">
                            <label class="form-label">School Code</label>
                            <input type="text" name="school_code" class="form-control" value="<?php echo htmlspecialchars($settings['school_code'] ?? ''); ?>">
                        </div>
                         <div class="col-md-6 mb-3">
