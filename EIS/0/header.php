    ...
    <div class="app-layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-menu">
                ...
                <a href="#" class="nav-item"><span>💼</span> Projects</a>
                <a href="#" class="nav-item"><span>⚙️</span> Settings</a>
            </nav>
            <div style="padding: 1.5rem; border-top: 1px solid rgba(255,255,255,0.1)">
                <div style="font-size: 0.8rem; opacity: 0.7; text-align: center"><a href="../logout.php" style="color: inherit; text-decoration: none;">Logout Admin</a></div>
            </div>
        </aside>
        ...
        <div class="main-wrapper">
            ...
            <header class="top-header">
                ...
                <div class="user-profile">
                    <span style="font-size: 0.9rem; font-weight: 500; margin-right: 0.5rem;">Alex Morgan</span>
